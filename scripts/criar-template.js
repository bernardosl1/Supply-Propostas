...
`;
  ...
  const header = tr([
    ...
    tc(p('VALOR UNIT�RIO', headerOptions), columns[5], { fill: grayFill, borders: headerBorders, margins: noMargins }),
  ...
  const itemRow = () => tr([
    ...
    tc(p('{descricao}', { ...itemOptions, bold: true }), columns[1], { borders: rowBottom }),
