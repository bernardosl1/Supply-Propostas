...
function priceTableXml() {
  const columns = [650, 760, 3040, 900, 720, 650, 1300, 1340];
...
`;
  ...
  const itemRow = () => tr([
    ...
    tc(p('{ncm}', { ...itemOptions, bold: true }), columns[3], { borders: rowBottom }),
    tc(p('{quant}', { ...itemOptions, bold: true }), columns[4], { borders: rowBottom }),
    tc(p('{un}', { ...itemOptions, bold: true }), columns[5], { borders: rowBottom }),
    tc(p('{valor_unit}', { ...itemOptions, bold: true }), columns[6], { borders: rowBottom }),
    tc(p('{valor_total}{/itens}', { ...itemOptions, bold: true }), columns[7], { borders: rowBottom })
  ]);
